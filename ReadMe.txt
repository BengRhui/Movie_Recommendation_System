...
The system might experience glitch in terms of GUI when it is accessed using the Windows operating system. The GUI will be the best if the system can be executed on a macOS system.
